    ...
    private void loadUserData() {
        ...
        userDataManager.fetchUserData(new OnUserDataLoadedListener() {
            ...
            public void onUserDataLoadFailed(String errorMessage) {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(TestActivity02.this, "Failed to load data: " + errorMessage, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void updateProfile() {
        ...
        userDataManager.updateUserProfile(name, email, bloodType, city,
                new OnUserDataLoadedListener() {
                    ...
                    public void onUserDataLoaded(String userName, String userEmail, String bloodType, String city) {
                        progressBar.setVisibility(View.GONE);
                        Intent intent = new Intent(TestActivity02.this, TextActivity.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                        finish();
                        Toast.makeText(TestActivity02.this, "Profile updated successfully", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onUserDataLoadFailed(String errorMessage) {
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(TestActivity02.this, "Update failed: " + errorMessage, Toast.LENGTH_SHORT).show();
                    }
                });
    }

    public void onBackPressed(View view) {
        startActivity(new android.content.Intent(this, TextActivity.class));
    }
}